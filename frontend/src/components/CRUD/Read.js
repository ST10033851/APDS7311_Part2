...
function Read() {
  ...
  return (
    ...
    <div className="relative overflow-x-auto shadow-md sm:rounded-lg" style={{ marginTop: "0px", maxWidth: "80%", margin: "0 auto" }}>
    <h1 style={{color:'white', fontSize:'50px', fontStyle:'bold', textAlign:'center'}} className="text-center text-2xl font-bold my-8">View Transactions</h1>
      <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
        <thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
          <tr>
            <th scope="col" className="px-6 py-3">Transaction Title</th>
